...
// InputPacket allows injecting a packet directly into the device's outbound pipeline.
// This is useful for integration with userspace network stacks like gvisor.
