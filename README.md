...
+ Добавлена поддержка протокола AmneziaWG 2.0: заменена ванильная реализация WG от SagerNet на AWG от Amnezia. Работоспособность ванильного wg под вопросом (не проверял - неначем)
