...
Если проект оказался полезным, вы можете поддержать его пожертвованием.

Пожертвования на сумму от 50 USD и выше могут быть отображены в [списке доноров](https://mtrdnt.pages.dev/donation_list) с вашим аватаром. Если вас ещё не добавили, можно связаться с авторами проекта.
